					...
					<ul class="nav navbar-nav">
						<li class="dropdown tasks-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<i class="fa fa-flag-o bg-black"></i>
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<img src="<?=base_url()?>uploads/photo/cashier.png" class="user-image">
								<span class="hidden-xs text-danger"><b><?=$this->fungsi->user_login()->username?></b></span>
							</a>
							<ul class="dropdown-menu">
								<li class="user-header">
									<img src="<?=base_url()?>uploads/photo/cashier.png" class="img-circle">
